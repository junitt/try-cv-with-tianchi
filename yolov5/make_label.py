...
train_annotation_path = 'F:/test_mission/input/mchar_train.json'
val_annotation_path = 'F:/test_mission/input/mchar_val.json'
train_data = json.load(open(train_annotation_path))
val_data = json.load(open(val_annotation_path))
label_path = 'F:/test_mission/datasets/coco/labels/'
